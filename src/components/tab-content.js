    ...
    return (
        ...
        <div className="themes wp-clearfix">
            {demosKeys.map(function (keyName, keyIndex) {
                return (
                    <Demo_Item slug={keyName} args={props.demos[keyName]} setSelectedDemo={props.setSelectedDemo} selectedDemo={props.selectedDemo} isAjaxLoading={props.isAjaxLoading}/>
                )
            })}
        </div>
