...
// Start Class
if (!class_exists('Qube_Tools_Demos')) {

    class Qube_Tools_Demos
    {
        ...
        public function __construct()
        {
            ...
            if (version_compare(PHP_VERSION, '5.4', '>=')) {
                require_once(QUBE_TOOLS_ABSPATH . 'includes/panel/classes/importers/class-helpers.php');
                require_once(QUBE_TOOLS_ABSPATH . 'includes/panel/classes/class-install-demos.php');
            }
        ...
        public static function scripts()
        {
            ...
            if ($screen_id !== 'qube-tools-options_page_qube-tools-install-demos') {
                return;
            }
        ...
        public static function ajax_demo_data()
        {
            ...
            <div id="qube-tools-demo-plugins">
                ...
                <div class="qube-tools-popup-text">
                    ...
                    <p><?php echo
                        sprintf(
                            esc_html__('Qube tools help you browse and import ready made websites with few clicks. We recommend you to upload sample data on a fresh WordPress install to prevent conflicts with your current content. You can use this plugin to reset your site if needed: %1$sWordpress Database Reset%2$s.', 'qube-tools-toolkit'),
                            '<a href="' . $plugin_link . '" target="_blank">',
                            '</a>'
                        ); ?></p>

                    <div class="qube-tools-required-plugins-wrap">
                        <h3><?php esc_html_e('Recommended Plugins', 'qube-tools-toolkit'); ?></h3>
                ...
                <a class="qube-tools-button qube-tools-plugins-next"
                   href="#"><?php esc_html_e('Next', 'qube-tools-toolkit'); ?></a>
            ...
            <form method="post" id="qube-tools-demo-import-form">
                ...
                <div class="qube-tools-demo-import-form-types">
                    ...
                    <h2 class="title"><?php esc_html_e('Select what you want to import:', 'qube-tools-toolkit'); ?></h2>
                        ...
                        <li>
                            <label for="qube_tools_import_xml">
                                <input id="qube_tools_import_xml" type="checkbox" name="qube_tools_import_xml"
                                       checked="checked"/>
                                <strong><?php esc_html_e('Import XML Data', 'qube-tools-toolkit'); ?></strong>
                                (<?php esc_html_e('pages, posts, images, menus, etc...', 'qube-tools-toolkit'); ?>)
                            </label>
                        </li>
                        ...
                        <li>
                            <label for="qube_tools_theme_settings">
                                <input id="qube_tools_theme_settings" type="checkbox" name="qube_tools_theme_settings"
                                       checked="checked"/>
                                <strong><?php esc_html_e('Import Customizer Settings', 'qube-tools-toolkit'); ?></strong>
                            </label>
                        </li>
                        ...
                        <li>
                            <label for="qube_tools_import_widgets">
                                <input id="qube_tools_import_widgets" type="checkbox" name="qube_tools_import_widgets"
                                       checked="checked"/>
                                <strong><?php esc_html_e('Import Widgets', 'qube-tools-toolkit'); ?></strong>
                            </label>
                        </li>
                ...
                <input type="submit" name="submit" class="qube-tools-button qube-tools-import"
                       value="<?php esc_html_e('Install', 'qube-tools-toolkit'); ?>"/>

            </form>

            <div class="qube-tools-loader">
                <h2 class="title"><?php esc_html_e('The import process could take some time, please be patient', 'qube-tools-toolkit'); ?></h2>
            ...
            <div class="qube-tools-last">
                <h2 style="font-size:45px;">🎉 🎉 <?php esc_html_e('Congratulations', 'qube-tools-toolkit'); ?> 🎉
                    🎉</h2>
                <h3><?php esc_html_e('Successfully Demo Imported!', 'qube-tools-toolkit'); ?></h3>
                <?php
                do_action('qube_tools_after_demo_import_success_message', $demo);
                ?>
                <a href="<?php echo esc_url(get_home_url()); ?>"
                   target="_blank"><?php esc_html_e('View Your Site', 'qube-tools-toolkit'); ?></a>
            </div>
        ...
        public function process_xml($file)
        {
            ...
            $response = Qube_Tools_Demos_Helpers::get_remote($file);
