<form class="qube-tools-demo-success-feedback" method="post" style="display:none;">
    <?php
    echo wp_nonce_field('qube_tools_demo_import_success_feedback_form') ?>
    ...
    <p><?php esc_html_e('Clicking on send button will send your feedback message, admin email, website url and installed demo name.', 'qube-tools'); ?></p>
    <button type="submit" name="qube_tools_demo_success_send" class="button button-secondary">
        <?php esc_html_e('Send', 'qube-tools'); ?>
    </button>
</form>
...
<a style="text-decoration: none;border: none;display: block;padding: 15px;background: #007cba;color: #fff;font-size: 20px;margin: 20px 0;border-radius: 50px;"
   href="https://wordpress.org/support/theme/check/reviews/?filter=5"
   target="_blank"><?php esc_html_e('Yes I Would Like to Write Review', 'qube-tools'); ?></a>